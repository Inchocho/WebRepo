...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function helloParameterFnc(greetStr) {
				alert(greetStr);				
			}			
...
<!--    인터랙티브(상호작용)하게 브라우저를 작동할 수 있다		 -->
	...
	<body>
		<button onclick="helloFnc();">
			안녕? 버튼
		</button>
		
		<button onclick="byeFnc();">
			잘가! 버튼
		</button>
		
		<button onclick="helloParameterFnc('뭐든입력해');">
			매개변수에 입력한값이 alert으로 나와!!
		</button>		
	</body>
