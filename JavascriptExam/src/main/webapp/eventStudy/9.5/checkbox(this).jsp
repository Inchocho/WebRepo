...
<html>
	<head>
	<title>checkbox this객체사용법</title>
	...
	<script type="text/javascript">
		...
		function allSel(myObj) {
			...
			//앞으로 this로 작업하게됨 this기준 this.value = '아 여기구나'
			...
			for (var i = 0; i < obj.length; i++) {
				...
				//checked가 true/false를 받아서 나머지 체크드를 다 바꿔줌
			}
		}
	</script>
	<style type="text/css">
	...
	<body>
		<form>
			<table>
				...
				<tr>
					<td>
						<input type="checkbox" value="아 여기구나"
							onclick="allSel(this);">전체선택<br>
						<!-- this는 자신의 값을 반환 -->
